...
{{- coalesce .Values.datadog.service (include "app.name" .) -}}
{{- end -}}
...
{{- coalesce .Values.datadog.version .Values.appVersionOverride .Values.image.tag (printf "%s-%d" .Chart.AppVersion .Release.Revision) -}}
{{- end -}}
...
*/}}
{{- define "datadog.env" -}}
{{- coalesce .Values.datadog.env .Values.env "unknown" -}}
{{- end -}}
...
{{- deepCopy .Values.pods.podLabels | merge $ddEnv $ddService $ddVersion | toYaml -}}
{{- else -}}
